        ...
        <template v-for="(v, i) in formItem" :key="i">
            <el-form-item :label="v.label" :prop="v.feild">
                ...
                <template v-if="v.type === 'input' || v.type === 'password'">
                    <el-input  :placeholder="v.placeholder" :show-password="v.type === 'password'"  v-model="modelValue[v.feild]"/>
                </template>
                     <!-- 验证码 -->
                ...
                <template v-else-if="v.type === 'date'">
                    <el-date-picker type="date" :placeholder="v.placeholder" style="width: 100%"  v-model="modelValue[v.feild]"/>
                </template>
