...
>
  ...
  import formConfig from '@/components/basic-data/processRoute/form'
  import updFormConfig from '@/components/basic-data/processRoute/uPd-processRoute'
  
  //表格配置数据
  import ElTable from '@/components/TableConfig/ElTable.vue'
  import tableConfig from '@/components/basic-data/processRoute/table'
  ...
  const btnSelect=()=>{
    ...
    List_processRoute(formData.value).then(res=>{
